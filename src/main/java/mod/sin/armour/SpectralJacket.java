...
public class SpectralJacket {
	public static final Logger logger = Logger.getLogger(SpectralJacket.class.getName());
	public static int templateId;
	private static final String NAME = "spectral jacket";
