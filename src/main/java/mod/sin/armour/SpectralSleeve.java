...
public class SpectralSleeve {
	public static final Logger logger = Logger.getLogger(SpectralSleeve.class.getName());
	public static int templateId;
	private static final String NAME = "spectral sleeve";
