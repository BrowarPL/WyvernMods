...
public class SpectralGlove {
	public static final Logger logger = Logger.getLogger(SpectralGlove.class.getName());
	public static int templateId;
	private static final String NAME = "spectral glove";
