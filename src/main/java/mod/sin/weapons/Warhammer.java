...
public class Warhammer {
	public static final Logger logger = Logger.getLogger(Warhammer.class.getName());
	public static int templateId;
	private static final String NAME = "warhammer";
		...
		if (templateId > 0) {
			...
			try {
				if (WarhammerHead.templateId > 0) {
					...
					logger.warning("WarhammerHead template ID is not initialized, skipping creation entry");
				}
			} catch (Exception e) {
