...
public class MaartensMight {
	public static final Logger logger = Logger.getLogger(MaartensMight.class.getName());
	public static int templateId;
	private static final String name = "Maarten's Might";
