...
public class TreasureMapCache {
	public static final Logger logger = Logger.getLogger(TreasureMapCache.class.getName());
	public static int templateId;
	private static final String NAME = "treasure map cache";
