...
public class AnimalCache {
	public static final Logger logger = Logger.getLogger(AnimalCache.class.getName());
	public static int templateId;
	private static final String NAME = "animal cache";

	public void createTemplate() throws IOException{
		try {
			ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.cache.animal");
			itemBuilder.name(NAME, "animal caches", "A cache containing the token of an animal. It might even be a unique creature.");
