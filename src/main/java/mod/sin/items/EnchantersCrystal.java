...
public class EnchantersCrystal {
	public static final Logger logger = Logger.getLogger(EnchantersCrystal.class.getName());
	public static int templateId;
	private static final String NAME = "enchanters crystal";
