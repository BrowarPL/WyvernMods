...
public class BookOfConversion {
	public static final Logger logger = Logger.getLogger(BookOfConversion.class.getName());
	public static int templateId;
	private static final String NAME = "book of conversion";
