...
public class StatuetteCyberhusky {
	public static final Logger logger = Logger.getLogger(StatuetteCyberhusky.class.getName());
	public static int templateId;
	private static final String name = "statuette of Reevi";
