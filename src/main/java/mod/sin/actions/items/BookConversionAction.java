...
public class BookConversionAction implements ModAction {
	private static final Logger logger = Logger.getLogger(BookConversionAction.class.getName());
		...
		return new ActionPerformer() {
			...
			public boolean action(Action act, Creature performer, Item target, short action, float counter)
			{
				if(performer instanceof Player){
					...
					BookConversionQuestion bcq = new BookConversionQuestion(performer, "Faith Conversion", "Which faith would you like to convert to?", performer.getWurmId(), target);
					bcq.sendQuestion();
				}else{
