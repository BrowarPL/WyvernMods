...
public class DepthDrillAction implements ModAction {
	public static final Logger logger = Logger.getLogger(DepthDrillAction.class.getName());

	private final short actionId;
	private final ActionEntry actionEntry;

	public DepthDrillAction() {
		logger.info("DepthDrillAction()");
	...
	public ActionPerformer getActionPerformer()
	{
		return new ActionPerformer() {
			...
			private void sendOres(Creature performer, int x, int y) throws NoSuchSkillException {
				...
				logger.info("Player "+performer.getName()+" uses depth drill at "+x+", "+y+" and prospects "+ores+" in the ground.");
