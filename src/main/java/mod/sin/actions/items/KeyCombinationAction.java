...
public class KeyCombinationAction implements ModAction {
	public static final Logger logger = Logger.getLogger(KeyCombinationAction.class.getName());

	private final short actionId;
	private final ActionEntry actionEntry;

	public KeyCombinationAction() {
		logger.info("KeyCombinationAction()");
	...
	public ActionPerformer getActionPerformer()
	{
		return new ActionPerformer() {
			...
			private void broadcast(Creature performer, int speaker, String message){
				String name;
				int r;
				int g;
				int b;
