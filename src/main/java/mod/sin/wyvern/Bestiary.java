...
public class Bestiary {
	public static final Logger logger = Logger.getLogger(Bestiary.class.getName());

	public static boolean isUsuallyHitched(int templateId){
		return templateId == Charger.templateId
				|| templateId == CreatureTemplateIds.HORSE_CID
				|| templateId == CreatureTemplateIds.HELL_HORSE_CID
				|| templateId == WyvernBlue.templateId
				|| templateId == WyvernBlack.templateId
	...
	public static boolean isNotHitchable(Creature creature){
		...
		int templateId = creature.getTemplate().getTemplateId();
		return templateId == Avenger.templateId
				|| templateId == Giant.templateId
				|| templateId == SpiritTroll.templateId
				|| templateId == Creatures.TROLL_CID
