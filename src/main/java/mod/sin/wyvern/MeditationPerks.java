    ...
    public static void preInit(){
        try{
            ...
            if (WyvernMods.enableMeditationAbilityCooldowns) {
                ...
                replace = "return this.path == 1 && this.level > 6 && System.currentTimeMillis() - this.cooldown2 > " + WyvernMods.loveEnchantNatureCooldown + ";";
                Util.setBodyDeclared(thisClass, ctCultist, "mayEnchantNature", replace);

                replace = "return this.path == 1 && this.level > 8 && System.currentTimeMillis() - this.cooldown3 > " + WyvernMods.loveLoveEffectCooldown + ";";
                Util.setBodyDeclared(thisClass, ctCultist, "mayStartLoveEffect", replace);

                replace = "return this.path == 2 && this.level > 6 && System.currentTimeMillis() - this.cooldown1 > " + WyvernMods.hateWarDamageCooldown + ";";
                Util.setBodyDeclared(thisClass, ctCultist, "mayStartDoubleWarDamage", replace);

                replace = "return this.path == 2 && this.level > 3 && System.currentTimeMillis() - this.cooldown2 > " + WyvernMods.hateStructureDamageCooldown + ";";
                Util.setBodyDeclared(thisClass, ctCultist, "mayStartDoubleStructDamage", replace);

                replace = "return this.path == 2 && this.level > 8 && System.currentTimeMillis() - this.cooldown3 > " + WyvernMods.hateFearCooldown + ";";
                Util.setBodyDeclared(thisClass, ctCultist, "mayStartFearEffect", replace);

                replace = "return this.path == 5 && this.level > 8 && System.currentTimeMillis() - this.cooldown1 > " + WyvernMods.powerElementalImmunityCooldown + ";";
                Util.setBodyDeclared(thisClass, ctCultist, "mayStartNoElementalDamage", replace);

                replace = "return this.path == 5 && this.level > 6 && System.currentTimeMillis() - this.cooldown2 > " + WyvernMods.powerEruptFreezeCooldown + ";";
                Util.setBodyDeclared(thisClass, ctCultist, "maySpawnVolcano", replace);

                replace = "return this.path == 5 && this.level > 3 && System.currentTimeMillis() - this.cooldown3 > " + WyvernMods.powerIgnoreTrapsCooldown + ";";
                Util.setBodyDeclared(thisClass, ctCultist, "mayStartIgnoreTraps", replace);

                replace = "return this.path == 3 && this.level > 3 && System.currentTimeMillis() - this.cooldown1 > " + WyvernMods.knowledgeInfoCreatureCooldown + ";";
